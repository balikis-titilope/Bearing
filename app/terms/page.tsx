            ...
            <main className={styles.page}>
                <div className={`container ${styles.container}`}>
                    ...
                    <div className={styles.content}>
                        ...
                        <section>
                            <h2 style={{ color: 'var(--primary)' }}>1. Use of Service</h2>
                            <p>
                        ...
                        <section>
                            <h2 style={{ color: 'var(--primary)' }}>2. Account Responsibilities</h2>
                            <p>
                        ...
                        <section>
                            <h2 style={{ color: 'var(--primary)' }}>3. AI Accuracy & Disclaimers</h2>
                            <p>
                        ...
                        <section>
                            <h2 style={{ color: 'var(--primary)' }}>4. Intellectual Property</h2>
                            <p>
                        ...
                        <section>
                            <h2 style={{ color: 'var(--primary)' }}>5. Limitation of Liability</h2>
                            <p>
                        ...
                        <section>
                            <h2 style={{ color: 'var(--primary)' }}>6. Changes to Terms</h2>
                            <p>
                        ...
                        <section>
                            <h2 style={{ color: 'var(--primary)' }}>7. Governing Law</h2>
                            <p>
