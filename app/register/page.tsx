...
import { Compass, CheckCircle2, ChevronRight, AlertCircle, CheckCircle } from 'lucide-react';
                ...
                <div className={styles.formWrapper}>
                    ...
                    <form className={styles.form} onSubmit={handleFormSubmit}>
                        ...
                        <div className={styles.inputGroup}>
                            ...
                            <input name="password" type="password" id="password" placeholder="Minimum 8 characters" className={styles.input} required disabled={isPending} />
                        </div>
